...
// Each day in the trip mapped to a date + coordinate. This is the one piece
// of trip-specific config that is NOT derived from src/data/*.json — edit it
// by hand to match your own trip's days, dates, and coordinates.
const DAY_LOCATIONS: Record<string, DayLocation | null> = {
  "day-1": { date: "2026-10-01", lat: 35.6762, lng: 139.6503 }, // Tokyo
  "day-2": { date: "2026-10-02", lat: 35.6762, lng: 139.6503 }, // Tokyo
  "day-3": { date: "2026-10-03", lat: 35.0116, lng: 135.7681 }, // Kyoto
};
